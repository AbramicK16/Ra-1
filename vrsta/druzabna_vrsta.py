...
class DruzabnaVrsta:
    ...
    def postrezi(self):
        ...
        vrsta.odstrani()
        while vrsta.prazna() or (odstraniPrvega not in self._slovarVrst.keys()):
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoxNjYwLCJwYXJ0IjoyMjAyMn0:1iL6OD:Z_AtH43u6FtdVbHVCx5lWAWG304'
        try:
