...
def kdaj_pridem_na_vrsto(otroci):
    ...
    while not vrsta.prazna():
        najmocnejsi = (0, 0) #otrok z najmočnejšo močjo je na začetku kar prvi otrok
        vrsta.vstavi(None)
        while vrsta.zacetek() != None: #pregledamo celo vrsto, dokler ne pridemo do zadnjega, ki ima najmanjši ind
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoxNjYwLCJwYXJ0IjoyMjE3Mn0:1iMtv1:YUju9VfltdHQPwNxOhZTbOeFIpA'
        try:
