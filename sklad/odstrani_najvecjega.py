...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoxNjYwLCJwYXJ0IjoyMTg0MH0:1iIaU5:6Qw4P2ON7Lj2GaGD5TQa1LDG7bI'
        try:
            test_data = [
                (["""s = Sklad()""",
                  """for i in range(10):""",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoxNjYwLCJwYXJ0IjoyMTg0MX0:1iIaU5:K6UJDSU_6IrS1lrX7_HuFirEsJY'
        try:
            test_data = [
                (["""s = Sklad()""",
                  """for i in range(10):""",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoxNjYwLCJwYXJ0IjoyMTg0Mn0:1iIaU5:TDOsm_lD-_hUVRlDIao02fjDpmQ'
        try:
            test_data = [
                (["""s = Sklad()""",
                  """for i in range(10):""",
