...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoxNjYwLCJwYXJ0IjoyMTk3NH0:1iRgpN:_ZmUmkjn4GymvljUfnpdRueh-lE'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoxNjYwLCJwYXJ0IjoyMTk3NX0:1iRgpN:Bl-IkFYcAoC10MNoj8FFff13gNc'
        try:
            test_data = [
                ("max_globina('burek')", 0),
