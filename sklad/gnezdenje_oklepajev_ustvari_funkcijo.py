...
#definicija poberi izbrise element, zato je ne uporabimo. Poberemo definicijo vrh, ki elementa ne izbrise
# =====================================================================@021859=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoxNjYwLCJwYXJ0IjoyMTg1OH0:1iIZD4:WIlCjvB01LYNC5Q6zFjMxJzGlJE'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoxNjYwLCJwYXJ0IjoyMTg1OX0:1iIZD4:bRCyWOGLwIFWo7lTZYu_rFXhjkY'
        try:
            test_data = [
                ("max_globina('burek')", 0),
